...
# Database: exciting
# Generation Time: 2016-09-18 06:01:18 +0000
# ************************************************************
...
VALUES
	(1,'2016-09-08 12:00:00',0,'2016-09-18 10:07:16',NULL,1,1,'weck','AOzYfJVv6gCIl4YFpKdt0Fh8MxKGKbdJ6qNFWsYtC1qmsL5LG4nBOfTwa4QQbV8Rg/63dgA849/tLqwEbsGMiOk=',NULL,'weck','HvkAy+OM8xv0qVjW+ZvAl91zJIIn/prIh/qgPVpzlGQ=','105851df200540d19a43f0aa678af987',1,1);
...
CREATE TABLE `water_conservation` (
  ...
  `constructtime` varchar(255) DEFAULT NULL,
...
INSERT INTO `water_conservation` (`id`, `create_time`, `is_delete`, `update_time`, `category`, `code`, `constructtime`, `construct_unit`, `manage_model`, `manager`, `name`, `property_owner`, `remark`, `situation`, `sum_estimate_investment`, `sum_fact_investment`, `county_id`, `group_id`, `location_id`, `project_mark_id`, `town_id`, `village_id`)
VALUES
	(1,'2016-09-08 12:08:23',0,'2016-09-08 12:08:23','渡槽','abcd','','','自管','','什么鬼渡槽','','','破损',NULL,NULL,1,2,2,1,3,2),
	(2,'2016-09-08 14:25:05',0,'2016-09-08 14:25:05','渡槽','abcd','','','自管','','什么鬼渡槽','','','破损',NULL,NULL,1,1,3,2,1,1),
	(3,'2016-09-08 14:26:06',0,'2016-09-08 14:26:06','渡槽','abcd','','','自管','','什么鬼渡槽','','','完好',NULL,NULL,1,2,4,3,3,2),
	(4,'2016-09-08 21:28:47',0,'2016-09-08 21:28:47','渡槽','abcd','','','自管','','什么鬼渡槽','','','完好',NULL,NULL,1,1,5,4,1,1),
	(5,'2016-09-17 20:26:22',0,'2016-09-17 20:26:22','泵站','ssssssvbb','2016年8月16日','vbb','委托管理','ghh','ghh','vbb','www','cbbb',NULL,NULL,1,1,11,5,1,1),
	(6,'2016-09-17 20:27:03',0,'2016-09-17 20:27:03','泵站','ssssssvbb','2016年8月16日','vbb','委托管理','ghh','ghh','vbb','www','cbbb',NULL,NULL,1,1,12,6,1,1),
	(7,'2016-09-17 21:39:38',0,'2016-09-17 21:39:38','泵站','ssssss','','','不限','','','','www','完好',NULL,NULL,1,1,14,7,1,1);
